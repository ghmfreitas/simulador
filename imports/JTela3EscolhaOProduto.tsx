import svgPaths from "./svg-5psbbwhogv";
  ...
  return (
    ...
    >
      <div className="basis-0 font-['Lintel:Bold',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#101213] text-[24px] text-left">
        <p className="block leading-[27px]">Deseja adicionar o Cuidado 360º?</p>
      </div>
    </div>
  );
}
...
function Frame1533210754() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-row items-start justify-start ml-0 mt-0 p-0 relative w-[435px]">
      <div
        className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6a7178] text-[0px] text-left w-[405px]"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="leading-[21px] text-[14px]">
          <span>{`O Cuidado 360º é um benefício da SulAmérica onde você pode incluir Seguro Odontológico e Seguro de Vida sem custo adicional. `}</span>
          <span className="font-['Lintel:Bold',_sans-serif] not-italic text-[#f05223]">
            Mais detalhes
          </span>
        </p>
      </div>
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-full">
      <div
        className="[grid-area:1_/_1] h-[9.406px] ml-[33.769%] mt-[75.546%] relative w-[10.974px]"
...
function Checkbox() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-center left-0 p-0 top-0 w-[435px]"
      data-name="Checkbox"
    >
      <Group1 />
    </div>
...
function Frame1533210796() {
  return (
    <div className="absolute h-[69px] left-0 top-[43px] w-[452px]">
      <Header />
      <Checkbox />
    </div>
  );
...
function Frame1533210794() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start left-0 p-0 top-[117px]">
      <RadioButton />
      <RadioButton1 />
    </div>
  );
...
function Area() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-4 items-start justify-center p-0 relative shrink-0 w-[452px]"
      data-name="Área"
    >
      <Frame1533210795 />
    </div>
...
export default function JTela3EscolhaOProduto() {
  return (
    <div
      className="bg-[#ffffff] relative size-full"
      data-name="[J] Tela 3 - Escolha o produto"
    >
      <Navbar />
      <SectionFooter1366Px />
      <Box />
