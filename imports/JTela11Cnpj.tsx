import svgPaths from "./svg-r74yeyzy52";
...
function Group238150() {
  return (
    <div className="h-5 relative shrink-0 w-[228.493px]">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
  ...
  return (
    ...
    >
      <div className="basis-0 font-['Lintel:Bold',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#101213] text-[24px] text-left">
        <p className="block leading-[27px]">Comece por aqui</p>
      </div>
    </div>
  );
}
...
function Header() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-3 items-start justify-start left-0 p-0 top-[-43px] w-[452px]"
      data-name="Header"
    >
      <Title />
    </div>
...
function Content() {
  return (
    <div
      className="absolute bottom-0 left-4 overflow-clip right-0 top-0"
      data-name="Content"
    >
      <IconLeftText />
    </div>
...
function Input() {
  return (
    <div
      className="bg-[#ffffff] h-10 relative rounded shrink-0 w-full"
      data-name="Input"
    >
...
function T1InputCnpj() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-[200px]"
      data-name="T1- Input - CNPJ"
    >
      <Input />
    </div>
  );
...
function Frame1533210794() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-4 items-start justify-start left-0 p-0 top-0">
      <Frame1533210817 />
    </div>
  );
}
...
function Frame1533210796() {
  return (
    <div className="absolute h-[69px] left-0 top-[43px] w-[303px]">
      <Header />
      <Frame1533210794 />
    </div>
  );
...
function Frame1533210795() {
  return (
    <div className="h-[189px] relative shrink-0 w-full">
      <Frame1533210796 />
    </div>
  );
}
...
function Area() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-4 h-28 items-start justify-start p-0 relative shrink-0 w-[452px]"
      data-name="Área"
    >
      <Frame1533210795 />
    </div>
...
function CnpjContainer() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[#272b30] text-left text-nowrap w-[241.5px]"
      data-name="CNPJ Container"
    >
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] justify-center relative shrink-0 text-[16px]">
        <p className="block leading-[21px] text-nowrap whitespace-pre">CNPJ</p>
      </div>
...
function RazaoSocial() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[#272b30] text-left w-[304px]"
      data-name="Razão Social"
    >
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] h-[17px] justify-center relative shrink-0 text-[16px] w-full">
        <p className="block leading-[21px]">Razão Social</p>
      </div>
      <div className="font-['Lintel:Regular',_sans-serif] relative shrink-0 text-[14px] w-full">
        <p className="block leading-[21px]">
          JOSEFA TANIA DOS SANTOS LIMA 11165789485
        </p>
      </div>
    </div>
  );
...
function NomeFantasia() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[#272b30] text-left w-[136px]"
      data-name="Nome Fantasia"
    >
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] h-[17px] justify-center relative shrink-0 text-[16px] w-full">
        <p className="block leading-[21px]">Nome Fantasia</p>
      </div>
      <div className="font-['Lintel:Regular',_sans-serif] relative shrink-0 text-[14px] w-full">
        <p className="block leading-[21px]">LUCAS GAS</p>
      </div>
    </div>
  );
}
...
function Logradouro() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start leading-[0] not-italic p-0 relative shrink-0 text-[#272b30] text-left w-full"
      data-name="Logradouro"
    >
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] h-[17px] justify-center relative shrink-0 text-[16px] w-full">
        <p className="block leading-[21px]">Endereço</p>
      </div>
      <div className="font-['Lintel:Regular',_sans-serif] relative shrink-0 text-[14px] w-full">
        <p className="block leading-[21px]">
          Rua Pirapora do Bom Jesus, 153 - Jd. Santa Clara - Guarulhos, SP
        </p>
      </div>
    </div>
  );
...
function Content1() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2 h-6 items-center justify-start overflow-clip p-0 relative shrink-0"
      data-name="Content"
    >
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#51810f] text-[12px] text-center text-nowrap">
        <p className="block leading-[18px] whitespace-pre">Ativo</p>
      </div>
    </div>
  );
}
...
function Tag() {
  return (
    <div
      className="bg-[#f1f8e8] box-border content-stretch flex flex-col gap-2 items-center justify-start overflow-clip px-2 py-0 relative rounded-[100px] shrink-0"
      data-name="Tag"
    >
      <Content1 />
    </div>
...
function Logradouro1() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0 w-full"
      data-name="Logradouro"
    >
      <div className="font-['Lintel:Bold',_sans-serif] h-[22px] leading-[0] not-italic relative shrink-0 text-[#272b30] text-[16px] text-left w-[46px]">
        <p className="block leading-[21px]">Status:</p>
      </div>
      <Tag />
    </div>
  );
...
function DetailsContainer() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-[452px]"
      data-name="Details Container"
    >
      <Cnpj />
      <RazaoSocial />
      <NomeFantasia />
...
function BackButton() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-0.5 h-8 items-center justify-start left-[-9px] p-0 top-0"
    ...
    >
      ...
      >
        <p className="block leading-[18px] whitespace-pre">Sair da simulação</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-row h-8 items-start justify-center overflow-clip p-0 relative rounded-[100px] shrink-0"
      data-name="Button"
    >
      <BackButton />
    </div>
...
function Box() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex flex-col gap-6 items-start justify-start left-1/2 p-[24px] translate-x-[-50%] translate-y-[-50%] w-[500px]"
      data-name="Box"
      style={{ top: "calc(50% - 258.5px)" }}
    >
      <Area />
      <DetailsContainer />
      <Frame1533210820 />
...
export default function JTela11Cnpj() {
  return (
    <div
      className="bg-[#ffffff] relative size-full"
      data-name="[J] Tela 1.1 - CNPJ"
    >
      <Navbar />
      <SectionFooter1366Px />
      <Box />
