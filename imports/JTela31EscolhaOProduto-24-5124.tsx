import svgPaths from "./svg-ahrwqzwuf4";
...
function Checkbox1() {
  return (
    ...
    >
      ...
      >
        <p className="block leading-[21px] whitespace-pre">Saúde</p>
      </div>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="absolute left-0.5 size-5 top-0.5" data-name="Icon">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function Checkbox2() {
  return (
    <div
      className="bg-[#f05223] relative rounded shrink-0 size-6"
      data-name="Checkbox"
    >
      <Icon />
    </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[21px] whitespace-pre">Odonto</p>
      </div>
    </div>
  );
}
...
function Frame1533210794() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start left-0 p-0 top-0">
      <div className="flex flex-col font-['Lintel:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#272b30] text-[14px] text-left text-nowrap">
        <p className="block leading-[21px] whitespace-pre">
          Selecione abaixo o(s) produto(s) que deseja simular:
        </p>
      </div>
      <Checkbox1 />
      <Checkbox3 />
...
export default function JTela31EscolhaOProduto() {
  return (
    <div
      className="bg-[#ffffff] relative size-full"
      data-name="[J] Tela 3.1 - Escolha o produto"
    >
      <Navbar />
      <SectionFooter1366Px />
      <Box />
