import svgPaths from "./svg-ndi6q01q4m";
...
function Content() {
  return (
    <div
      className="absolute bottom-0 left-4 overflow-clip right-[-27px] top-0"
      data-name="Content"
    >
      <IconLeftText />
    </div>
...
export default function JTela1Cnpj() {
  return (
    <div
      className="bg-[#ffffff] relative size-full"
      data-name="[J] Tela 1 - CNPJ"
    >
      <Navbar />
      <SectionFooter1366Px />
      <Box />
