import svgPaths from "./svg-0gnn4groqs";
...
function PopupHeader() {
  return (
    <div
      ...
      data-name="Popup Header"
    >
      <PopupTitleContainer />
      <div className="font-['Lintel:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#272b30] text-[14px] text-left w-full">
...
function Content() {
  return (
    <div className="absolute inset-0 overflow-clip" data-name="Content">
      <div className="absolute flex flex-col font-['Lintel:Regular',_sans-serif] h-[9px] justify-center leading-[0] left-[26px] not-italic text-[#6a7178] text-[14px] text-center top-[26.5px] translate-x-[-50%] translate-y-[-50%] w-1.5">
        <p className="block leading-[21px]">0</p>
      </div>
    </div>
  );
}

function T5InputVidas() {
  return (
    <div
      className="bg-[#ffffff] relative rounded shrink-0 size-[52px]"
      data-name="T5 - Input - Vidas"
    >
      <div className="overflow-clip relative size-[52px]">
        <Content />
      </div>
...
function Component0018() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-center justify-start p-0 relative shrink-0 w-[52px]"
      data-name="00 - 18"
    >
      <div
        className="flex flex-col font-['Lintel:Bold',_sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#000000] text-[12px] text-center"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">0 - 18</p>
      </div>
      <T5InputVidas />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">19 - 23</p>
      </div>
      <T5InputVidas1 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">24 - 28</p>
      </div>
      <T5InputVidas2 />
    </div>
  );
...
function Component2933() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0 w-[52px]"
      data-name="29 - 33"
    >
      <div
        className="flex flex-col font-['Lintel:Bold',_sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#000000] text-[12px] text-center"
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">29 - 33</p>
      </div>
      <T5InputVidas3 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">34 - 38</p>
      </div>
      <T5InputVidas4 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">39 - 43</p>
      </div>
      <T5InputVidas5 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">49 - 53</p>
      </div>
      <T5InputVidas6 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">49 - 54</p>
      </div>
      <T5InputVidas7 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">54 - 58</p>
      </div>
      <T5InputVidas8 />
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "min-content" }}
      >
        <p className="block leading-[21px]">59+</p>
      </div>
      <T5InputVidas9 />
    </div>
  );
...
function ButtonIcon() {
  return (
    <div className="relative shrink-0 size-[22.1px]" data-name="Button Icon">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function Frame7() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2 h-10 items-center justify-start p-0 relative shrink-0">
      <div className="flex flex-col font-['Lintel:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#adb5bd] text-[14px] text-center text-nowrap">
...
function BtnContinuar1Disabled() {
  return (
    <div
      className="bg-[#f1f3f5] h-10 relative rounded-[100px] shrink-0"
      data-name="Btn - Continuar 1 - Disabled"
    >
      ...
      <div className="absolute border border-[#dee2e6] border-solid inset-0 pointer-events-none rounded-[100px]" />
    </div>
  );
}

function T5BtnContinuar5() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-start justify-start p-0 relative shrink-0 w-[88px]"
      data-name="T5 - Btn - Continuar 5"
    >
      <BtnContinuar1Disabled />
    </div>
  );
}
...
function Popup() {
  return (
    <div
      className="absolute bg-[#ffffff] box-border content-stretch flex flex-col gap-2.5 items-start justify-start left-1/2 p-[24px] translate-x-[-50%] translate-y-[-50%] w-[500px]"
      data-name="Popup"
      style={{ top: "calc(50% - 309.5px)" }}
    >
      <PopupContainer />
    </div>
  );
...
export default function JTela4SimuleParaSaude() {
  return (
    <div
      className="bg-[#ffffff] relative size-full"
      data-name="[J] Tela 4 - Simule para Saúde"
    >
      <Navbar />
      <SectionFooter1366Px />
      <Popup />
